...
public class Controller {
    ...
    private void settingUserData() {
        ...
        String regex = (String.valueOf(View.bundle.getLocale()).equals("ua")) ? REGEX_NAME_UKR : REGEX_NAME_LAT;
        String firstName = controller.inputStringValueWithScanner(ENTER_FIRST_NAME, regex);
        ...
        model.setTable(firstName, login, telephone);
        model.sendToFile();
    }
}